...
<html lang="en">
  <head>
    ...
    <!-- base:css -->
    <link rel="stylesheet" href="{{asset('admincss/template/vendors/typicons.font/font/typicons.css')}}">
    <link rel="stylesheet" href="{{asset('admincss/template/vendors/css/vendor.bundle.base.css')}}">
    <!-- endinject --> 
    <!-- plugin css for this page -->
    <!-- End plugin css for this page -->
    <!-- inject:css -->
    <link rel="stylesheet" href="{{asset('admincss/template/css/vertical-layout-light/style.css')}}">
    <!-- endinject -->
    <link rel="shortcut icon" href="{{asset('admincss/template/images/favicon.png')}}" />
  </head>
  <body>
    ...
    <!-- container-scroller -->
    <!-- base:js -->
    <script src="{{asset('admincss/template/vendors/js/vendor.bundle.base.js')}}"></script>
    <!-- endinject -->
    ...
    <!-- endinject -->
    <!-- plugin js for this page -->
    <script src="{{asset('admincss/vendors/progressbar.js/progressbar.min.js')}}"></script>
